...
<div class="form-group <?php echo $id; ?>_field clearfix<?php $hidden and print ' not-active'; ?>">
	...
	<div class="col-sm-<?php echo $size; ?>">
		<input type="<?php echo $type; ?>" id="<?php echo $id; ?>" name="<?php echo $name; ?>" class="form-control <?php echo join(' ', $classes); ?>" placeholder="<?php echo $placeholder; ?>" value="<?php echo $value; ?>"<?php echo ($min === false ? '' : ' min="' . $min . '"') ?><?php echo ($max === false ? '' : ' max="' . $max . '"') ?><?php $disabled and print ' disabled'; ?> />

<?php
use Jigoshop\Admin\ThemeOptions;
...
<div class="wrap jigoshop">
	...
	foreach ($tabs as $tab): /** @var $tab \Jigoshop\Admin\Settings\TabInterface */
		...
		$menuContent .= '<li class="' . $active . '">' .
			'<a href="?page=' . ThemeOptions::NAME . '&amp;tab=' . $tab->getSlug() . '">' . $tab->getTitle() . '</a>' .
		'</li>';
	endforeach; ?>
	...
	<div class="tab-content">
		<div class="tab-pane active">
			<form action="options.php" method="post" enctype="multipart/form-data" role="form" class="clearfix">
				...
				<?php settings_fields(ThemeOptions::NAME); ?>
				<?php do_settings_sections(ThemeOptions::NAME); ?>

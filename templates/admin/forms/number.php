	...
	<div class="row">
		<div class="col-sm-<?php echo $size; ?>">
			...
			<div class="col-xs-<?php echo $size - 2 ?> col-sm-<?php echo $size - 1 ?>">
				<input type="<?php echo $type; ?>" id="<?php echo $id; ?>" name="<?php echo $name; ?>" class="form-control <?php echo join(' ', $classes); ?>" placeholder="<?php echo $placeholder; ?>" step="<?php echo $step; ?>" value="<?php echo $value; ?>"<?php echo($min === false ? '' : ' min="' . $min . '"') ?><?php echo($max === false ? '' : ' max="' . $max . '"') ?> />

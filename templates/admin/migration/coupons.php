...
<button type="submit" name="tool" value="<?php echo Jigoshop\Admin\Migration\Products::ID; ?>" class="btn btn-default btn-block migration-reset-coupons">reset coup</button>

...
<button type="submit" name="tool" value="<?php echo Jigoshop\Admin\Migration\Emails::ID; ?>" class="btn btn-default btn-block migration-reset-emails">reset emails</button>

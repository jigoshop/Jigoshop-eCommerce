...
<button type="submit" name="tool" value="<?php echo Jigoshop\Admin\Migration\Orders::ID; ?>" class="btn btn-default btn-block migration-reset-orders">reset orders</button>

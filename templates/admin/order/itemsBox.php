	...
	<div class="form-horizontal">
		<table class="table table-striped" data-order="<?= $order->getId(); ?>">
			...
			<tr>
				...
				<th scope="col"><?php Forms::constant(array('name' => 'order[items][sku]', 'value' => __('SKU', 'jigoshop'))); ?></th>
				<th scope="col"><?php Forms::constant(array('size' => 12,'name' => 'order[items][name]', 'value' => __('Name', 'jigoshop'))); ?></th>
				<th scope="col"><?php Forms::constant(array('size' => 12,'name' => 'order[items][unit_price]', 'value' => sprintf(__('Unit price (%s)', 'jigoshop'), Currency::symbol()))); ?></th>
				<th scope="col"><?php Forms::constant(array('size' => 12,'name' => 'order[items][qty]', 'value' => __('Quantity', 'jigoshop'))); ?></th>
				<th scope="col"><?php Forms::constant(array('name' => 'order[items][id][price]', 'value' => __('Price', 'jigoshop'))); ?></th>
				<th scope="col"></th>
			</tr>
			</thead>
			<tbody>
			...
			<tr>
				...
				<td id="product-subtotal"><?php Forms::constant(array('name' => 'order[subtotal]', 'value' => Product::formatPrice($order->getProductSubtotal()))); ?></td>
				<td></td>
			</tr>
			</tfoot>
		</table>

...
,                ),
            ...
            'from' => array(
                'posts' => 'WP_POSTS' //TODO: replace this value.
            ),
            'join' => array(
                'total_sales' => array(
                    'table' => 'WP_POSTMETA', //TODO: relpace this value.
                    'on' => array(
                        array(
                        'key' => 'post_id',
                        'value' => 'posts.ID',
                        ...
                        array(
                            'key' => 'meta_key',
                            'value' => 'total_sales', //TODO: check this key.
                            'compare' => '=',
                        ),
                    ),
                ),
                'total_tax' => array(
                    ...
                    'on' => array(
                        ...
                        array(
                            'key' => 'meta_key',
                            'value' => 'total_tax', //TODO: check this key.
                            'compare' => '=',
                        ),
                    ),
                ),
                'total_shipping' => array(
                    ...
                    'on' => array(
                        ...
                        array(
                            'key' => 'meta_key',
                            'value' => 'total_shipping', //TODO: check this key.
                            'compare' => '=',
                        ),
                    ),
                ),
                'discount_amount' => array(
                    ...
                    'on' => array(
                        ...
                        array(
                            'key' => 'meta_key',
                            'value' => 'discount_amount', //TODO: check this key.
                            'compare' => '=',
                        ),
                    ),
                ),
                'order_item_count' => array(
                    'table' => 'WP_JIGOSHOP_ORDER_ITEMS', //TODO: replace this value.
                    'on' => array(
                        array(
                            'key' => 'order_id',
                            'value' => 'posts.ID',

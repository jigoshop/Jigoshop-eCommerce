					...
					var series = [
						{
							...
							color: '<?php echo $this->chartColours['item_count']; ?>',
							bars: {
								fillColor: '<?php echo $this->chartColours['item_count']; ?>',
								fill: true,
								show: true,
								lineWidth: 0,
								align: 'left',
						...
						},
						{
							...
							color: '<?php echo $this->chartColours['order_count']; ?>',
							bars: {
								fillColor: '<?php echo $this->chartColours['order_count']; ?>',
								fill: true,
								show: true,
								lineWidth: 0,
								align: 'right',
						...
						},
						{
							...
							yaxis: 2,
							color: '<?php echo $this->chartColours['average']; ?>',
							points: {show: false},
						...
						},
						{
							...
							yaxis: 2,
							color: '<?php echo $this->chartColours['coupon_amount']; ?>',
							points: {show: true, radius: 5, lineWidth: 2, fillColor: '#fff', fill: true},
							lines: {show: true, lineWidth: 2, fill: false},
							shadowSize: 0,
							<?php echo $this->getCurrencyTooltip(); ?>
						},
						{
							label: "<?php echo esc_js( __( 'Shipping amount', 'jigoshop' ) ) ?>",
							data: order_data.shipping_amounts,
							yaxis: 2,
							color: '<?php echo $this->chartColours['shipping_amount']; ?>',
							points: {show: true, radius: 5, lineWidth: 2, fillColor: '#fff', fill: true},
							lines: {show: true, lineWidth: 2, fill: false},
							shadowSize: 0,
							prepend_tooltip: "<?php echo Currency::symbol(); ?>"
						},
						{
							label: "<?php echo esc_js( __( 'Gross Sales amount', 'jigoshop' ) ) ?>",
							data: order_data.order_amounts,
							yaxis: 2,
							color: '<?php echo $this->chartColours['sales_amount']; ?>',
							points: {show: true, radius: 5, lineWidth: 2, fillColor: '#fff', fill: true},
							lines: {show: true, lineWidth: 2, fill: false},
							shadowSize: 0,
							<?php echo $this->getCurrencyTooltip(); ?>
						},
						{
							...
							yaxis: 2,
							color: '<?php echo $this->chartColours['net_sales_amount']; ?>',
